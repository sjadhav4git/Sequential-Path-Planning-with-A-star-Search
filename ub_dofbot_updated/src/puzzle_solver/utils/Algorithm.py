...
class Algorithm:
    ...
    def neighbor_elements(self, center_location):
        neighbor = []
    ...
    def first_check_matched(self,puzzle_pattern,target_pattern): 
        match_list = []
...
#------------------------------------------------------------------------------------------------------------             
    ...
    def A_star_for_blank_path(self,start_point,goal_point,lock_positions,temp_lock_position):
        # create_grid
