...
import json
import main
from Arm_Lib import Arm_Device#New_line

msg = Float64MultiArray()
Arm = Arm_Device()#New_line
...
def solve_moves(feed_moves:int,joint_var:list):
    ...
    while not rospy.is_shutdown() or i < lenght_joint_var:
        ...
        if i ==0:
            ...
            pub.publish(msg)
            Arm.Arm_serial_servo_write6(90.0,90.0,90.0,90.0,th5,th6,1000)#New_line
            i+=1
            ...
            pub.publish(msg)
            Arm.Arm_serial_servo_write6(th1-err,th2,th3,th4,th5,th6,1000)
            i+=1
            rate.sleep()
            rate.sleep()
            rate.sleep()
            ...
            pub.publish(msg)
            Arm.Arm_serial_servo_write6(th1-err,th2,th3,th4,th5,th6,feed_time*3)
        ...
        if i == lenght_joint_var:
            ...
            pub.publish(msg)
            Arm.Arm_serial_servo_write6(90.0, 90.0, 90.0, 0.0, th5, th6,1000)
            rate.sleep()
            rospy.sleep(1.2)
            msg.data = [90.0, 180.0, 0.0, 0.0, th5, th6,1000]
            pub.publish(msg)
            Arm.Arm_serial_servo_write6(90.0, 180.0, 0.0, 0.0, th5, th6,1000)
            rate.sleep()
            rospy.sleep(1)
            # progress_bar.end()
